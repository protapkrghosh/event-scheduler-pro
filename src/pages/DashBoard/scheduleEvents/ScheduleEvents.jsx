      ...
      <Tabs className="border border-gray-300 rounded-md pb-5">
        <TabList className="flex justify-between items-center px-5 border-b-2 border-gray-300 h-[55px]">
          <div className="flex justify-center items-center gap-x-5">
            ...
            <div className="relative">
              <button
                ...
                className={`react-tabs flex justify-center items-center gap-x-2`}
              >
                Date Range{" "}
                <FaCaretDown
              ...
              <div className={`${open ? "absolute top-[42px]" : "hidden"}`}>
                <DateRange></DateRange>
              </div>
            </div>
          ...
          <div className="flex justify-center items-center gap-x-4">
            <button className="flex justify-center items-center gap-x-2 border border-black  py-1 px-3 rounded-full">
