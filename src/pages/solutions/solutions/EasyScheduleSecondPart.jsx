...
const EasyScheduleSecondPart = ({title, heading, para, link, img}) => {
    return (
        <div className="lg:w-9/12 mx-auto flex flex-col lg:flex-row-reverse justify-center items-center gap-x-16">
