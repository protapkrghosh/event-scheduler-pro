  ...
  return (
    <div className="mt-10 lg:mt-40 mb-20">
      <div className="w-11/12 md:w-1/2 mx-auto  ">
        ...
        >
          <div className=" w-full h-52 shadow-sm rounded-xl p-5 hover:scale-105 duration-500">
            ...
            <p className="text-gray-500 mb-2">
              I’ve used Setmore for over 3 years, its a brilliant booking app
              that does all the hard work for me!
            </p>
            <p>―Rowena Gledhill</p>
          </div>
          <div className="w-full h-24 hover:scale-105 duration-500 p-3 shadow-xl rounded-xl border-t border-gray-200 mb-12 lg:mb-0">
            ...
            <p>
              <span>4.6/5 rating</span> based on 233 reviews on Facebook.
            </p>
          </div>
        ...
        >
          <div className="bg-yellow-500 rounded-lg w-full  h-64 lg:h-52 flex items-end justify-center hover:scale-105 duration-500">
            <img
          ...
          <div className=" w-full shadow-xl rounded-xl p-5 border border-gray-200 hover:scale-105 duration-500">
            <h6 className="text-lg font-prompt mb-2">Facebook</h6>
            <p className="text-gray-500 mb-2">
              I’ve used Setmore for over 3 years, its a brilliant booking app
              that does all the hard work for me!
        ...
        >
          <div className="w-full h-24 hover:scale-105 duration-500 p-3 shadow-xl rounded-xl border border-gray-200 flex items-center">
            <img
              src="https://assets.setmore.com/website/v2/images/icons/logo-badge-capterra.png"
              alt=""
            />
            <p className="text-xl font-cursive">Reservations</p>
          </div>
          ...
          <div className="w-full h-24 hover:scale-105 duration-500 p-3 shadow-xl rounded-xl border border-gray-200 flex items-center">
            <img
              src="https://assets.setmore.com/website/v2/images/icons/logo-badge-getapp.png"
              alt=""
            />
